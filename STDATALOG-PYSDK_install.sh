...
if [ -z $1 ]; then
    python3 -m pip install stdatalog_pnpl/dist/stdatalog_pnpl-1.1.0-py3-none-any.whl
else
    python3 -m pip install stdatalog_pnpl/dist/stdatalog_pnpl-1.1.0-py3-none-any.whl --proxy=$1
fi
...
if [ -z $1 ]; then
    python3 -m pip install stdatalog_core/dist/stdatalog_core-1.1.0-py3-none-any.whl
else
    python3 -m pip install stdatalog_core/dist/stdatalog_core-1.1.0-py3-none-any.whl --proxy=$1
fi
...
if [ -z $1 ]; then
    python3 -m pip install stdatalog_dtk/dist/stdatalog_dtk-1.1.0-py3-none-any.whl
else
    python3 -m pip install stdatalog_dtk/dist/stdatalog_dtk-1.1.0-py3-none-any.whl --proxy=$1
fi
...
if [ -z $1 ]; then
    python3 -m pip install stdatalog_gui/dist/stdatalog_gui-1.1.0-py3-none-any.whl
else
    python3 -m pip install stdatalog_gui/dist/stdatalog_gui-1.1.0-py3-none-any.whl --proxy=$1
fi