...
if "%proxy_string%"=="" (python -m pip install stdatalog_pnpl\dist\stdatalog_pnpl-1.0.0-py3-none-any.whl) else (python -m pip install stdatalog_pnpl\dist\stdatalog_pnpl-1.0.0-py3-none-any.whl --proxy %proxy_string%)
...
if "%proxy_string%"=="" (python -m pip install stdatalog_core\dist\stdatalog_core-1.0.0-py3-none-any.whl) else (python -m pip install stdatalog_core\dist\stdatalog_core-1.0.0-py3-none-any.whl --proxy %proxy_string%)
...
if "%proxy_string%"=="" (python -m pip install stdatalog_dtk\dist\stdatalog_dtk-1.0.0-py3-none-any.whl) else (python -m pip install stdatalog_dtk\dist\stdatalog_dtk-1.0.0-py3-none-any.whl --proxy %proxy_string%)
...
if "%proxy_string%"=="" (python -m pip install stdatalog_gui\dist\stdatalog_gui-1.0.0-py3-none-any.whl) else (python -m pip install stdatalog_gui\dist\stdatalog_gui-1.0.0-py3-none-any.whl --proxy %proxy_string%) 
PAUSE
