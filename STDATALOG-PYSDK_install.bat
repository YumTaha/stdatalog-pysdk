...
if "%proxy_string%"=="" (python -m pip install stdatalog_dtk\dist\stdatalog_dtk-1.2.0-py3-none-any.whl) else (python -m pip install stdatalog_dtk\dist\stdatalog_dtk-1.2.0-py3-none-any.whl --proxy %proxy_string%)
...
if "%proxy_string%"=="" (python -m pip install stdatalog_gui\dist\stdatalog_gui-1.2.0-py3-none-any.whl) else (python -m pip install stdatalog_gui\dist\stdatalog_gui-1.2.0-py3-none-any.whl --proxy %proxy_string%) 
PAUSE
